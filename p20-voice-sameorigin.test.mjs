...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v279-clean-notif-20260917'") && H.includes('sw.js?v=v279-clean-notif-20260917') && H.includes("const expectedSwVersion = 'v279-clean-notif-20260917'") && H.includes("const cur = 'admission-hub-shell-v279-clean-notif-20260917'"));

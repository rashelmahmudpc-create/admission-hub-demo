...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v277-fcm-enable-fix-20260917'") && H.includes('sw.js?v=v277-fcm-enable-fix-20260917') && H.includes("const expectedSwVersion = 'v277-fcm-enable-fix-20260917'") && H.includes("const cur = 'admission-hub-shell-v277-fcm-enable-fix-20260917'"));

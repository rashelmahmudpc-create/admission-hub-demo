...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v273-push-fix-20260917'") && H.includes('sw.js?v=v273-push-fix-20260917') && H.includes("const expectedSwVersion = 'v273-push-fix-20260917'") && H.includes("const cur = 'admission-hub-shell-v273-push-fix-20260917'"));

...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v249-scroll-safe-20260914'") && H.includes('sw.js?v=v249-scroll-safe-20260914') && H.includes("const expectedSwVersion = 'v249-scroll-safe-20260914'") && H.includes("const cur = 'admission-hub-shell-v249-scroll-safe-20260914'"));

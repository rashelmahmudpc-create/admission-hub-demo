...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v254-login-input-20260914'") && H.includes('sw.js?v=v254-login-input-20260914') && H.includes("const expectedSwVersion = 'v254-login-input-20260914'") && H.includes("const cur = 'admission-hub-shell-v254-login-input-20260914'"));

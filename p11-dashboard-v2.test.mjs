...
t('sw BUILD_ID v284-analytics-foundation-20260924', SW.includes("const BUILD_ID = 'v284-analytics-foundation-20260924'"));
t('index sw-marker v195', H.includes('sw.js?v=v284-analytics-foundation-20260924'));

...
t('sw BUILD_ID v255-session-engine-20260915', SW.includes("const BUILD_ID = 'v255-session-engine-20260915'"));
t('index sw-marker v195', H.includes('sw.js?v=v255-session-engine-20260915'));

...
t('sw BUILD_ID v281-auth-error-20260918', SW.includes("const BUILD_ID = 'v281-auth-error-20260918'"));
t('index sw-marker v195', H.includes('sw.js?v=v281-auth-error-20260918'));

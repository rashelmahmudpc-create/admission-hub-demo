...
t('sw BUILD_ID v280-global-notif-20260917', SW.includes("const BUILD_ID = 'v280-global-notif-20260917'"));
t('index sw-marker v195', H.includes('sw.js?v=v280-global-notif-20260917'));

...
t('sw BUILD_ID v276-fcm-sw-ready-20260917', SW.includes("const BUILD_ID = 'v276-fcm-sw-ready-20260917'"));
t('index sw-marker v195', H.includes('sw.js?v=v276-fcm-sw-ready-20260917'));

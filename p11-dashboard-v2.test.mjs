...
t('sw BUILD_ID v248-natural-welcome-20260914', SW.includes("const BUILD_ID = 'v248-natural-welcome-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v248-natural-welcome-20260914'));

...
t('sw BUILD_ID v251-created-screen-20260914', SW.includes("const BUILD_ID = 'v251-created-screen-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v251-created-screen-20260914'));

...
t('sw BUILD_ID v275-nav4-fcm-sw-20260917', SW.includes("const BUILD_ID = 'v275-nav4-fcm-sw-20260917'"));
t('index sw-marker v195', H.includes('sw.js?v=v275-nav4-fcm-sw-20260917'));

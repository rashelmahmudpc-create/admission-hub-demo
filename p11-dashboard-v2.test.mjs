...
t('sw BUILD_ID v273-push-fix-20260917', SW.includes("const BUILD_ID = 'v273-push-fix-20260917'"));
t('index sw-marker v195', H.includes('sw.js?v=v273-push-fix-20260917'));

...
t('sw BUILD_ID v244-premium-welcome-20260914', SW.includes("const BUILD_ID = 'v244-premium-welcome-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v244-premium-welcome-20260914'));

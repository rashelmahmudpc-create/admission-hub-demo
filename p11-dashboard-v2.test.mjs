...
t('sw BUILD_ID v246-fit-welcome-20260914', SW.includes("const BUILD_ID = 'v246-fit-welcome-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v246-fit-welcome-20260914'));

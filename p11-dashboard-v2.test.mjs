...
t('sw BUILD_ID v274-ai-in-dashboard-20260916', SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'"));
t('index sw-marker v195', H.includes('sw.js?v=v274-ai-in-dashboard-20260916'));

...
t('sw BUILD_ID v283-single-email-button-20260921', SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'"));
t('index sw-marker v195', H.includes('sw.js?v=v283-single-email-button-20260921'));

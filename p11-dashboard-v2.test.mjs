...
t('sw BUILD_ID v250-education-page-20260914', SW.includes("const BUILD_ID = 'v250-education-page-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v250-education-page-20260914'));

...
t('sw BUILD_ID v270-uni-tap-theme-goal-20260915', SW.includes("const BUILD_ID = 'v270-uni-tap-theme-goal-20260915'"));
t('index sw-marker v195', H.includes('sw.js?v=v270-uni-tap-theme-goal-20260915'));

...
/* ১ — ফাইল-লোড + ক্যাশ-কী */
t('dashboard-v2.js defer-লোড (?v=dash2)', H.includes('<script defer src="./dashboard-v2.js?v=dash2f12-clean"></script>'));
t('dashboard-v2.css link (?v=dash2)', H.includes('<link rel="stylesheet" href="./dashboard-v2.css?v=dash2f11-clean">'));
t('sw APP_SHELL-এ dashboard-v2 (js+css)', SW.includes("'./dashboard-v2.js?v=dash2f12-clean'") && SW.includes("'./dashboard-v2.css?v=dash2f11-clean'"));
t('sw BUILD_ID v269-lang-coverage-20260915', SW.includes("const BUILD_ID = 'v269-lang-coverage-20260915'"));
t('index sw-marker v195', H.includes('sw.js?v=v269-lang-coverage-20260915'));
...
t('১৪ মূল অ্যাপের AI Assistant script/nav/dashboard/direct route চালু', H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv17-clean') && H.includes("key:'ai'") && H.includes("if(p==='ai'){ if(window.renderAiAgentPage)") && V2.includes("navigate('ai')") && V2.includes("navigate(\\'ai\\')"));

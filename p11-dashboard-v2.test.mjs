...
t('sw BUILD_ID v249-scroll-safe-20260914', SW.includes("const BUILD_ID = 'v249-scroll-safe-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v249-scroll-safe-20260914'));

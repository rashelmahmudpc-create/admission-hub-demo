...
t('sw BUILD_ID v253-login-input-20260914', SW.includes("const BUILD_ID = 'v253-login-input-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v253-login-input-20260914'));

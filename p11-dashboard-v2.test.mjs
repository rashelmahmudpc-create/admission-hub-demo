...
t('sw BUILD_ID v290-analytics-dashboard-20260925', SW.includes("const BUILD_ID = 'v290-analytics-dashboard-20260925'"));
t('index sw-marker v195', H.includes('sw.js?v=v290-analytics-dashboard-20260925'));

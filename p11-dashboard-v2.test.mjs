...
t('১৪ মূল অ্যাপের AI Assistant script/dashboard-এন্ট্রি/direct route চালু (floating FAB নেই)', H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && !H.includes('juju-floating') && H.includes("if(p==='ai'){ if(window.renderAiAgentPage)") && V2.includes("navigate('ai')") && V2.includes("navigate(\\'ai\\')"));

...
t('sw BUILD_ID v282-device-challenge-20260921', SW.includes("const BUILD_ID = 'v282-device-challenge-20260921'"));
t('index sw-marker v195', H.includes('sw.js?v=v282-device-challenge-20260921'));

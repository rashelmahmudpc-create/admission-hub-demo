...
t('sw BUILD_ID v256-security-core-20260915', SW.includes("const BUILD_ID = 'v256-security-core-20260915'"));
t('index sw-marker v195', H.includes('sw.js?v=v256-security-core-20260915'));

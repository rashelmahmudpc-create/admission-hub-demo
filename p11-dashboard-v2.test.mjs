...
t('sw BUILD_ID v254-login-input-20260914', SW.includes("const BUILD_ID = 'v254-login-input-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v254-login-input-20260914'));

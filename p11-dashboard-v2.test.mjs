...
t('sw BUILD_ID v277-fcm-enable-fix-20260917', SW.includes("const BUILD_ID = 'v277-fcm-enable-fix-20260917'"));
t('index sw-marker v195', H.includes('sw.js?v=v277-fcm-enable-fix-20260917'));

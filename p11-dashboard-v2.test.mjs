...
t('sw BUILD_ID v252-login-verify-20260914', SW.includes("const BUILD_ID = 'v252-login-verify-20260914'"));
t('index sw-marker v195', H.includes('sw.js?v=v252-login-verify-20260914'));

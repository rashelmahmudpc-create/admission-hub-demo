...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v273-nav4-juju-20260916'"));
t('index sw-marker current shell', H.includes('sw.js?v=v273-nav4-juju-20260916'));

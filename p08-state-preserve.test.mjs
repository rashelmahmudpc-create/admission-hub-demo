...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v267-profile-v12-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v267-profile-v12-20260915'));

...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v272-nojs-landing-20260916'"));
t('index sw-marker current shell', H.includes('sw.js?v=v272-nojs-landing-20260916'));

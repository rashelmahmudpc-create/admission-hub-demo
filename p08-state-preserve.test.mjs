...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'"));
t('index sw-marker current shell', H.includes('sw.js?v=v289-notification-intelligence-20260925'));

...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'"));
t('index sw-marker current shell', H.includes('sw.js?v=v274-ai-in-dashboard-20260916'));

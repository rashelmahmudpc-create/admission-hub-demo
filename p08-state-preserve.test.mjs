...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v270-uni-tap-theme-goal-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v270-uni-tap-theme-goal-20260915'));

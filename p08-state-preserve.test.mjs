...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v244-premium-welcome-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v244-premium-welcome-20260914'));

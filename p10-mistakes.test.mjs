...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v260-profile-v7-20260916'"));
t('index sw-marker current shell', H.includes('sw.js?v=v260-profile-v7-20260916'));

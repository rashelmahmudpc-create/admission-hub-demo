...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v249-scroll-safe-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v249-scroll-safe-20260914'));

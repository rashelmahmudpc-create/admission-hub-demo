...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v277-fcm-enable-fix-20260917'"));
t('index sw-marker current shell', H.includes('sw.js?v=v277-fcm-enable-fix-20260917'));

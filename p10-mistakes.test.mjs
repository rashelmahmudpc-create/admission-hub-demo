...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v256-security-core-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v256-security-core-20260915'));

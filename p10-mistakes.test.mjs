...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v290-analytics-dashboard-20260925'"));
t('index sw-marker current shell', H.includes('sw.js?v=v290-analytics-dashboard-20260925'));

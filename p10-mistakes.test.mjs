...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v248-natural-welcome-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v248-natural-welcome-20260914'));

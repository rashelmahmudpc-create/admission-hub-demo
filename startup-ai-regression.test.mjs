...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v257-profile-core-20260915'") && H.includes("const expectedSwVersion = 'v257-profile-core-20260915'") && H.includes('sw.js?v=v257-profile-core-20260915') && H.includes('account-access.js?v=20260916-account-entry-v2') && SW.includes('account-access.js?v=20260916-account-entry-v2') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));

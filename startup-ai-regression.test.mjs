...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v260-profile-v7-20260916'") && H.includes("const expectedSwVersion = 'v260-profile-v7-20260916'") && H.includes('sw.js?v=v260-profile-v7-20260916') && H.includes('account-access.js?v=20260916-account-entry-v4') && SW.includes('account-access.js?v=20260916-account-entry-v4') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));

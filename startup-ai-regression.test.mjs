...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v259-profile-v6-20260916'") && H.includes("const expectedSwVersion = 'v259-profile-v6-20260916'") && H.includes('sw.js?v=v259-profile-v6-20260916') && H.includes('account-access.js?v=20260916-account-entry-v3') && SW.includes('account-access.js?v=20260916-account-entry-v3') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));

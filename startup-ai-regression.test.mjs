...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v281-auth-error-20260918'") && H.includes("const expectedSwVersion = 'v281-auth-error-20260918'") && H.includes('sw.js?v=v281-auth-error-20260918') && H.includes('account-access.js?v=20260918-auth-error-v7') && SW.includes('account-access.js?v=20260918-auth-error-v7') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));

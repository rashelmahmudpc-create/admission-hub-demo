...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v286-lesson-quiz-analytics-20260925'") &&
  H.includes("const expectedSwVersion = 'v286-lesson-quiz-analytics-20260925'") &&
  H.includes('sw.js?v=v286-lesson-quiz-analytics-20260925') &&
  H.includes('admission-hub-shell-v286-lesson-quiz-analytics-20260925'));

...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v268-lang-theme-20260915'") &&
  H.includes("const expectedSwVersion = 'v268-lang-theme-20260915'") &&
  H.includes('sw.js?v=v268-lang-theme-20260915') &&
  H.includes('admission-hub-shell-v268-lang-theme-20260915'));

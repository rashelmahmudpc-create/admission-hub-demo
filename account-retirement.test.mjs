...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v277-fcm-enable-fix-20260917'") &&
  H.includes("const expectedSwVersion = 'v277-fcm-enable-fix-20260917'") &&
  H.includes('sw.js?v=v277-fcm-enable-fix-20260917') &&
  H.includes('admission-hub-shell-v277-fcm-enable-fix-20260917'));

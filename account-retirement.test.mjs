...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") &&
  H.includes("const expectedSwVersion = 'v289-notification-intelligence-20260925'") &&
  H.includes('sw.js?v=v289-notification-intelligence-20260925') &&
  H.includes('admission-hub-shell-v289-notification-intelligence-20260925'));

...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v269-lang-coverage-20260915'") &&
  H.includes("const expectedSwVersion = 'v269-lang-coverage-20260915'") &&
  H.includes('sw.js?v=v269-lang-coverage-20260915') &&
  H.includes('admission-hub-shell-v269-lang-coverage-20260915'));

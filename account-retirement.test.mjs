...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v285-learning-instrumentation-20260925'") &&
  H.includes("const expectedSwVersion = 'v285-learning-instrumentation-20260925'") &&
  H.includes('sw.js?v=v285-learning-instrumentation-20260925') &&
  H.includes('admission-hub-shell-v285-learning-instrumentation-20260925'));

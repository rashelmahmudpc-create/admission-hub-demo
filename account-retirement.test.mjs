...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v284-notification-command-center-20260924'") &&
  H.includes("const expectedSwVersion = 'v284-notification-command-center-20260924'") &&
  H.includes('sw.js?v=v284-notification-command-center-20260924') &&
  H.includes('admission-hub-shell-v284-notification-command-center-20260924'));

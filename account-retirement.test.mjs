...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v288-learning-insights-20260925'") &&
  H.includes("const expectedSwVersion = 'v288-learning-insights-20260925'") &&
  H.includes('sw.js?v=v288-learning-insights-20260925') &&
  H.includes('admission-hub-shell-v288-learning-insights-20260925'));

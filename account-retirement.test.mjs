...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v276-fcm-sw-ready-20260917'") &&
  H.includes("const expectedSwVersion = 'v276-fcm-sw-ready-20260917'") &&
  H.includes('sw.js?v=v276-fcm-sw-ready-20260917') &&
  H.includes('admission-hub-shell-v276-fcm-sw-ready-20260917'));

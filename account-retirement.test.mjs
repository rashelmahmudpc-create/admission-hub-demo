...
await test('service-worker build and HTML registration are synchronized',
  ...
  SW.includes("const BUILD_ID = 'v275-nav4-fcm-sw-20260917'") &&
  H.includes("const expectedSwVersion = 'v275-nav4-fcm-sw-20260917'") &&
  H.includes('sw.js?v=v275-nav4-fcm-sw-20260917') &&
  H.includes('admission-hub-shell-v275-nav4-fcm-sw-20260917'));

...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v249-scroll-safe-20260914'") &&
  H.includes("const expectedSwVersion = 'v249-scroll-safe-20260914'") &&
  H.includes('sw.js?v=v249-scroll-safe-20260914') &&
  H.includes('admission-hub-shell-v249-scroll-safe-20260914'));
...
await test('premium account and institution assets use synchronized cache-busting versions',
  ['account-access.css?v=20260914-scroll-safe-v1', 'account-access.js?v=20260914-scroll-safe-v1', 'institutions-bd.js?v=bd-institutions-v1']
    .every(asset => H.includes(asset) && SW.includes(asset)) &&
  H.indexOf('institutions-bd.js?v=bd-institutions-v1') < H.indexOf('account-access.js?v=20260914-scroll-safe-v1'));

...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f11-profile-tap') && SW.includes("'./dashboard-v2.js?v=dash2f11-profile-tap'") && SW.includes("const BUILD_ID = 'v257-profile-core-20260915'") && H.includes('sw.js?v=v257-profile-core-20260915'));

...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f13-theme') && SW.includes("'./dashboard-v2.js?v=dash2f13-theme'") && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && H.includes('sw.js?v=v274-ai-in-dashboard-20260916'));

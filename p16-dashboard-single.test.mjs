...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f15-inbox') && SW.includes("'./dashboard-v2.js?v=dash2f15-inbox'") && SW.includes("const BUILD_ID = 'v284-analytics-foundation-20260924'") && H.includes('sw.js?v=v284-analytics-foundation-20260924'));

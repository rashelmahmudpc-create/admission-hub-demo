...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f10-main-ai') && SW.includes("'./dashboard-v2.js?v=dash2f10-main-ai'") && SW.includes("const BUILD_ID = 'v256-security-core-20260915'") && H.includes('sw.js?v=v256-security-core-20260915'));

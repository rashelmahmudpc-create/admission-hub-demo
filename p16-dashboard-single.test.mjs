...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f11-profile-tap') && SW.includes("'./dashboard-v2.js?v=dash2f11-profile-tap'") && SW.includes("const BUILD_ID = 'v263-selfheal-20260916'") && H.includes('sw.js?v=v263-selfheal-20260916'));

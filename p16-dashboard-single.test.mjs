...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f12-clean') && SW.includes("'./dashboard-v2.js?v=dash2f12-clean'") && SW.includes("const BUILD_ID = 'v264-cleancache-20260916'") && H.includes('sw.js?v=v264-cleancache-20260916'));

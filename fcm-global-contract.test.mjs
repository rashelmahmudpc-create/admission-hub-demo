...
test('pin consistency: index.html script pins match sw.js cache entries + digests', () => {
  ...
  assert.match(INDEX, /v280-global-notif-20260917/g);
  assert.match(SW, /const BUILD_ID = 'v280-global-notif-20260917';/);
  assert.ok((INDEX.match(/v280-global-notif-20260917/g) || []).length >= 3, 'canary pinned in index.html (register + SW check)');
});

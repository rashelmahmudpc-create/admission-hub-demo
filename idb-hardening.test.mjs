...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v244-premium-welcome-20260914'") && H.includes('sw.js?v=v244-premium-welcome-20260914'));

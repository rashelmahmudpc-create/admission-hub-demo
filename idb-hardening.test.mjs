...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v270-uni-tap-theme-goal-20260915'") && H.includes('sw.js?v=v270-uni-tap-theme-goal-20260915'));

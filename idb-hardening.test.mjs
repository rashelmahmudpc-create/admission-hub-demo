...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v250-education-page-20260914'") && H.includes('sw.js?v=v250-education-page-20260914'));

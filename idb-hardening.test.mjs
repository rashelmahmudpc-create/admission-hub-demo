...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v255-session-engine-20260915'") && H.includes('sw.js?v=v255-session-engine-20260915'));

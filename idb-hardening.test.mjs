...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v269-lang-coverage-20260915'") && H.includes('sw.js?v=v269-lang-coverage-20260915'));

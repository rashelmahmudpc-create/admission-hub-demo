...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && H.includes('sw.js?v=v283-single-email-button-20260921'));

...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v277-fcm-enable-fix-20260917'") && H.includes('sw.js?v=v277-fcm-enable-fix-20260917'));

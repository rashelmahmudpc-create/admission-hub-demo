...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v256-security-core-20260915'") && H.includes('sw.js?v=v256-security-core-20260915'));

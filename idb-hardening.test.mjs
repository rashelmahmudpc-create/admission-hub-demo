...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v282-device-challenge-20260921'") && H.includes('sw.js?v=v282-device-challenge-20260921'));

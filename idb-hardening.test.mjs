...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v278-toast-visible-20260917'") && H.includes('sw.js?v=v278-toast-visible-20260917'));

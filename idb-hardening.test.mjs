...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v288-learning-insights-20260925'") && H.includes('sw.js?v=v288-learning-insights-20260925'));

...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v285-learning-instrumentation-20260925'") && H.includes('sw.js?v=v285-learning-instrumentation-20260925'));

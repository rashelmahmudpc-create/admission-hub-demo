...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v251-created-screen-20260914'") && H.includes('sw.js?v=v251-created-screen-20260914'));

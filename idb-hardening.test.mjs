...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && H.includes('sw.js?v=v274-ai-in-dashboard-20260916'));

...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v248-natural-welcome-20260914'") && H.includes('sw.js?v=v248-natural-welcome-20260914'));

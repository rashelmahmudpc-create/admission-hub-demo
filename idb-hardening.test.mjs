...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v245-clean-welcome-20260914'") && H.includes('sw.js?v=v245-clean-welcome-20260914'));

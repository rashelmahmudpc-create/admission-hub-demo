...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && H.includes('sw.js?v=v289-notification-intelligence-20260925'));

...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v284-notification-command-center-20260924'") && H.includes('sw.js?v=v284-notification-command-center-20260924'));

...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v290-analytics-dashboard-20260925'") && H.includes('sw.js?v=v290-analytics-dashboard-20260925'));

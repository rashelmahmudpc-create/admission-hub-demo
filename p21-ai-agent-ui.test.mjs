...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && H.includes('sw.js?v=v283-single-email-button-20260921') && H.includes("const expectedSwVersion = 'v283-single-email-button-20260921'"));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && H.includes("const expectedSwVersion = 'v283-single-email-button-20260921'") && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));

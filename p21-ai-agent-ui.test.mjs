...
t('২. ai-agent-chat.js স্ক্রিপ্ট-ট্যাগ (chatv1)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৩২. sw APP_SHELL: anonymous AI chatv14 + dash2f10-main-ai', SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && SW.includes('./dashboard-v2.js?v=dash2f15-inbox') && H.includes('dashboard-v2.js?v=dash2f15-inbox'));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && H.includes("const expectedSwVersion = 'v283-single-email-button-20260921'") && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions') && H.includes('sw.js?v=v283-single-email-button-20260921') && SW.includes("const BUILD_ID = 'v283-single-email-button-20260921'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv19-actions'));

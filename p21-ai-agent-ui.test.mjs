...
t('২. ai-agent-chat.js স্ক্রিপ্ট-ট্যাগ (chatv1)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৪. NAV_TABS থেকে 🤖 AI ট্যাব বাদ — AI এখন dashboard Command Center + সরাসরি /ai রুট', (H.match(/const NAV_TABS=\[[\s\S]*?\];/) || [''])[0].length > 0 && !(H.match(/const NAV_TABS=\[[\s\S]*?\];/) || [''])[0].includes("key:'ai'") && !H.includes('juju-floating') && H.includes("if(p==='ai'){ if(window.renderAiAgentPage)"));
...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && H.includes('sw.js?v=v289-notification-intelligence-20260925') && H.includes("const expectedSwVersion = 'v289-notification-intelligence-20260925'"));
t('৩২. sw APP_SHELL: anonymous AI chatv14 + dash2f10-main-ai', SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && SW.includes('./dashboard-v2.js?v=dash2f15-inbox') && H.includes('dashboard-v2.js?v=dash2f15-inbox'));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && H.includes("const expectedSwVersion = 'v289-notification-intelligence-20260925'") && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs') && H.includes('sw.js?v=v289-notification-intelligence-20260925') && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv20-autoprefs'));

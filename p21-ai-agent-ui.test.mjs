...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && H.includes("const expectedSwVersion = 'v274-ai-in-dashboard-20260916'"));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && H.includes("const expectedSwVersion = 'v274-ai-in-dashboard-20260916'") && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh') && H.includes('sw.js?v=v274-ai-in-dashboard-20260916') && SW.includes("const BUILD_ID = 'v274-ai-in-dashboard-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv18-fresh'));

...
t('২. ai-agent-chat.js স্ক্রিপ্ট-ট্যাগ (chatv1)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && H.includes('sw.js?v=v262-catalog-instant-20260916') && H.includes("const expectedSwVersion = 'v262-catalog-instant-20260916'"));
t('৩২. sw APP_SHELL: anonymous AI chatv14 + dash2f10-main-ai', SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && SW.includes('./dashboard-v2.js?v=dash2f11-profile-tap') && H.includes('dashboard-v2.js?v=dash2f11-profile-tap'));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && H.includes("const expectedSwVersion = 'v262-catalog-instant-20260916'") && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization') && H.includes('sw.js?v=v262-catalog-instant-20260916') && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization'));

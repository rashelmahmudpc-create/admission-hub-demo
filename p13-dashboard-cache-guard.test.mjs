...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('<script defer src="./dashboard-v2.js?v=dash2f11-profile-tap"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f11-profile-tap'") && SW.includes("const BUILD_ID = 'v262-catalog-instant-20260916'") && H.includes('sw.js?v=v262-catalog-instant-20260916') && H.includes("const expectedSwVersion = 'v262-catalog-instant-20260916'") && !H.includes('v196-gfix'));

...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('<script defer src="./dashboard-v2.js?v=dash2f15-inbox"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f15-inbox'") && SW.includes("const BUILD_ID = 'v289-notification-intelligence-20260925'") && H.includes('sw.js?v=v289-notification-intelligence-20260925') && H.includes("const expectedSwVersion = 'v289-notification-intelligence-20260925'") && !H.includes('v196-gfix'));

...
const BUILD_ID = 'v261-profile-v8-20260916';
...
const APP_SHELL = [
  ...
  './dashboard-v2.css?v=dash2f10',
  './3d-loader.css?v=3d-v1',
  './session-persist.js?v=session-v1',
  './account-access.css?v=20260916-account-entry-v4',
  './institutions-bd.js?v=bd-institutions-v1',
  './account-access.js?v=20260916-account-entry-v4',
  './profile-ui.js?v=profile-v8',
  './profile-ui.css?v=profile-v8',
  './data-protection.js?v=dp-v3-fastboot',
  './dashboard-v2.js?v=dash2f11-profile-tap',
  './ai-agent-chat.js?v=agent-f1-ui-chatv16-personalization',
  './icons/icon-192.png',
  './icons/icon-512.png'
];

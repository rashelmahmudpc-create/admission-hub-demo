...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v269-lang-coverage-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v269-lang-coverage-20260915'));

...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v268-lang-theme-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v268-lang-theme-20260915'));

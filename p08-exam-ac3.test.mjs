...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v259-profile-v6-20260916'"));
t('index sw-marker current shell', H.includes('sw.js?v=v259-profile-v6-20260916'));

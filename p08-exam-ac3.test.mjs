...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v266-profile-v11-20260915'"));
t('index sw-marker current shell', H.includes('sw.js?v=v266-profile-v11-20260915'));

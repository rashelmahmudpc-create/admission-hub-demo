...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v250-education-page-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v250-education-page-20260914'));

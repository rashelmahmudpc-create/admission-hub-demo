...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v246-fit-welcome-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v246-fit-welcome-20260914'));

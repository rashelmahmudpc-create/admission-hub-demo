...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v252-login-verify-20260914'"));
t('index sw-marker current shell', H.includes('sw.js?v=v252-login-verify-20260914'));
